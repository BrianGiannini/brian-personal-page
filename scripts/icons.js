// SVG Sprite Sheet Injector
// Centralizes icon definitions for reuse across the site
...
<svg style="display: none;">
    <defs>
        ...
        <!-- Up Arrow (Show Less) - Calculated as polyline or just reverse down? Using specific path found in code previously -->
        ...
        <!-- GitHub Icon -->
        <symbol id="icon-github" viewBox="0 0 24 24" fill="var(--color-text-main)">
        ...
        <!-- Styles for default icon behavior can be added here or in CSS -->
    </defs>
</svg>
`;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Prepend to body to ensure symbols are available immediately
